        ...
        <div class="col-12 col-md-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-2 py-md-3">
                    <h5 class="mb-0 fw-bold fs-6 fs-md-5">Edit Produk: {{ $product->name }}</h5>
                </div>
                <div class="card-body p-2 p-md-3">
                    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-2 mb-md-3">
                            <label class="form-label fs-7 fs-md-6">Nama Produk <span class="text-danger">*</span></label>
                        ...
                        <div class="row g-2">
                            <div class="col-6 col-md-12 mb-2 mb-md-3">
                                <label class="form-label fs-7 fs-md-6">Harga (Rp) <span class="text-danger">*</span></label>
                                ...
                                @error('price') <div class="invalid-feedback fs-8">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-6 col-md-12 mb-2 mb-md-3">
                                <label class="form-label fs-7 fs-md-6">Stok <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3 mb-md-4">
                            <label class="form-label fs-7 fs-md-6">Ganti Foto Produk (Opsional)</label>
                            @if($product->image)
                                <div class="mb-2">
                            ...
                            <input type="file" name="image" class="form-control form-control-sm @error('image') is-invalid @enderror"
                                   accept="image/*">
                            <small class="text-muted fs-8">Biarkan kosong jika tidak mengubah.</small>
                            @error('image') <div class="invalid-feedback fs-8">{{ $message }}</div> @enderror
                        </div>

                        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-between">
                            <a href="{{ route('admin.products.index') }}" class="btn btn-secondary btn-sm fs-7 fs-md-6">Batal</a>
                            <button type="submit" class="btn btn-success fw-bold btn-sm fs-7 fs-md-6">Update</button>
                        </div>
                    </form>
                </div>
            </div>
